            ...
            <div class="row">
                <%
                    try {
                        ...
                        String query = "SELECT DISTINCT SUBSTRING(movies.title, 1, 1) AS initial FROM movies ORDER BY initial";
                        ResultSet result = statement.executeQuery(query);
                        out.println("<div class=\"col-xs-6 col-lg-4\">");
                        while (result.next()) {
                            String initial = result.getString("initial");
                            out.println("<p><a class=\"btn btn-default\" href='/Fabflix/BrowseByMovieTitle?initial=" + initial + "' role=\"button\">" + initial + " &raquo;</a></p>");
                        }
                        out.println("</div>");
                        result.close();
                        statement.close();
